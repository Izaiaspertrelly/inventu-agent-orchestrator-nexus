  ...
  return (
    <div className="flex min-h-screen bg-black">
      <div className="relative w-full max-w-md m-auto p-0.5 rounded-3xl">
        ...
        {/* Frosted glass container - neutral transparent background */}
        <div className="relative bg-gray-900/40 backdrop-blur-xl p-10 rounded-3xl z-10 shadow-lg border border-white/10">
